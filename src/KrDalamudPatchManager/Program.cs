...
internal sealed class PatchModule
{
    ...
    public static List<PatchModule> CreateAll() => new()
    {
        ...
        new PatchModule(
            "bossmodreborn", "BossModReborn KR 데이터", "KR 데이터", "BossModReborn", new[] { "7.5.1.26", "7.5.1.29", "7.5.1.32", "7.5.1.35" }, new[] { "BossModReborn.dll" }, "KR Lumina 시트 · legacy map-effect 제거",
